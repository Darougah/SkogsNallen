...
const PostAreview = ({ isModalOpen, handleClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(error?.data?.message || "Något gick fel vid postning av recension.");
    }
  };

  return (
    <div className={`fixed inset-0 bg-black/80 flex items-center justify-center z-40 px-2 ${isModalOpen ? 'block' : 'hidden'}`}>
      <div className='bg-white p-6 rounded-md shadow-lg w-96 z-50'>
        <h2 className='text-lg font-medium mb-4'>Skriv en recension</h2>
